...
Write a function called sortNames that takes an array of names and 
...
that takes an array of numbers and sorts them from smallest to largest.
...
const sortByPrice = (arr) => {
  // Solution code here...
  const val = (a, b) => {
    let priceA = a.price, priceB = b.price;
