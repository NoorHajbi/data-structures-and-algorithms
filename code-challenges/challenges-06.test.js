'use strict';
/*
https://www.youtube.com/watch?v=8lVbQYfS0Rg&list=PLVngfM2hsbi-L6G8qlWd8RyRbuTamHt3k&index=3
...
const getNames = (arr) => {
  ...
  let newArr = [];
  arr.map(val => {
    newArr.push(`${val.name.split('').reduce((newString, currentLetter) => {
...
a new property to the object called yearBorn. The value of the yearBorn property should
 be the integer that was passed in.
